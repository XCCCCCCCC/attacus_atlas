...
CREATE TABLE `loan_detail` (
  ...
  `business_license` varchar(100) DEFAULT NULL COMMENT '生意营业执照',
  `business_position` varchar(100) DEFAULT NULL COMMENT '生意职位',
  `business_hour` double DEFAULT NULL COMMENT '生意经营时长',
  `business_address` varchar(1000) DEFAULT NULL COMMENT '生意经营地址',
  `business_industry` varchar(100) DEFAULT NULL COMMENT '生意经营行业',
  `business_flow` double DEFAULT NULL COMMENT '生意流水',
  `business_tax` double DEFAULT NULL COMMENT '生意税',
  `house_local` varchar(10) DEFAULT NULL COMMENT '房产屋是否本地',
  `house_region` varchar(100) DEFAULT NULL COMMENT '房产屋区域',
  `house_buy_method` varchar(100) DEFAULT NULL COMMENT '房产屋购买方式',
  `house_value` double DEFAULT NULL COMMENT '房产屋市值(单位为万)',
  `house_monthly_payment` double DEFAULT NULL COMMENT '房产屋月供(单位为元)',
  `house_payment_period` int(11) DEFAULT NULL COMMENT '房产屋还款期数(单位为月)',
  `house_age` double DEFAULT NULL COMMENT '房产龄(单位为年)',
  `house_interest_num` int(11) DEFAULT NULL COMMENT '房产屋权利人数',
  `house_interest_age` int(11) DEFAULT NULL COMMENT '房产屋权利人年龄',
  `house_is_mortgage` int(11) DEFAULT NULL COMMENT '房产屋是否抵押(无/一押)',
  `car_local` varchar(10) DEFAULT NULL COMMENT '车辆是否本地',
  `car_license` varchar(10) DEFAULT NULL COMMENT '车辆牌照',
  `car_buy_method` varchar(10) DEFAULT NULL COMMENT '车辆购买方式',
  `car_value` double DEFAULT NULL COMMENT '车辆辆市值(单位为万)',
  `car_monthly_payment` varchar(10) DEFAULT NULL COMMENT '车辆月供(单位为元)',
  `car_payment_period` varchar(10) DEFAULT NULL COMMENT '车辆还款期数(单位为月)',
  `car_age` int(11) DEFAULT NULL COMMENT '车辆龄(单位为年)',
  `car_use_km` double DEFAULT NULL COMMENT '车辆龄(单位为公里)',
